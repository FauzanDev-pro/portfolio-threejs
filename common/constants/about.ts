export const ABOUT = [
    "Hello there! Thank you for visiting my personal website. I'm Fauzan Fuadi, a student from smp negeri 02 jatibarang. I have a strong interest in the futures of technology. With a solid foundation in JavaScript and TypeScript, as well as a comprehensive understanding of various frontend libraries and frameworks, I have navigated the ever-evolving landscape of web development with enthusiasm and dedication.",
